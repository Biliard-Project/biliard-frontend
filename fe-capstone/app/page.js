      ...
      <Head>
        ...
        <div className="flex flex-row items-center justify-between bg-lightgreen w-full py-8 md:py-14 px-8 md:px-20">
          ...
          <div className="flex flex-col w-full lg:w-8/12">
            ...
            <div>
              <button className="bg-darkgreen w-44 md:w-48 text-lg md:text-xl py-2 rounded-3xl text-white font-semibold mt-8 hover:shadow-lg active:shadow-md active:scale-95 transform hover:scale-105 transition duration-300">
                <a href="/login">
                  Get Started
                </a>
              </button>
        ...
        <div className="flex flex-col md:flex-row gap-5 mb-20 lg:mb-32 px-6 md:px-0">
          <div className="flex flex-row md:flex-col justify-center items-center font-semibold w-11/12 md:w-5/12 gap-4 md:gap-6">
            <img src="/assets/lp1.png" className="w-30 h-30 md:w-50 md:h-50 lg:w-70 lg:h-70 object-contain"/>
          ...
          <div className="flex flex-row md:flex-col justify-center items-center font-semibold w-11/12 md:w-5/12 gap-4 md:gap-6">
            <img src="/assets/lp2.png" className="w-30 h-30 md:w-50 md:h-50 lg:w-70 lg:h-70 object-contain"/>
          ...
          <div className="flex flex-row md:flex-col items-center justify-center font-semibold w-11/12 md:w-5/12 gap-4 md:gap-6">
            <img src="/assets/lp3.png" className="w-30 h-30 md:w-50 md:h-50 lg:w-70 lg:h-70 object-contain"/>
        ...
        <div className="flex items-center justify-center bg-darkgreen w-full py-6 md:py-10 lg:py-14 text-3xl md:text-5xl font-bold text-white">
            Why us?
        </div>
        <div className="flex flex-col w-full lg:w-10/12 bg-white px-10 md:px-20 lg:px-40 py-14 md:py-20 lg:py-28 gap-10 md:gap-16 lg:gap-20">
          <FeatureSection
            number={1}
